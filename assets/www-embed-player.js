...
function xa(a,b){a.l={Xb:b,ec:!0};a.i=a.s||a.o}
...
function Ca(a){var b=a.v.splice(0)[0];(b=a.l=a.l||b)?b.ec?a.i=a.s||a.o:void 0!=b.u&&a.o<b.u?(a.i=b.u,a.l=null):a.i=a.o:a.i=0}
...
function Ga(a){for(;a.i.i;)try{var b=a.j(a.i);if(b)return a.i.C=!1,{value:b.value,done:!1}}catch(c){a.i.j=void 0,xa(a.i,c)}a.i.C=!1;if(a.i.l){b=a.i.l;a.i.l=null;if(b.ec)throw b.Xb;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
var f=new c;b.prototype.R=function(g){var h=this.m();g.Xa(h.resolve,h.reject)};
...
this.Xa(k(g,m),k(h,q));return r};
b.prototype.catch=function(g){return this.then(void 0,g)};
b.prototype.Xa=function(g,h){function k(){switch(m.i){case 1:g(m.l);break;case 2:h(m.l);break;default:throw Error("Unexpected state: "+m.i);}}
var m=this;null==this.j?f.j(k):this.j.push(k);this.C=!0};
b.resolve=d;b.reject=function(g){return new b(function(h,k){k(g)})};
b.race=function(g){return new b(function(h,k){for(var m=p(g),q=m.next();!q.done;q=m.next())d(q.value).Xa(h,k)})};
b.all=function(g){var h=p(g),k=h.next();return k.done?d([]):new b(function(m,q){function r(A){return function(E){w[A]=E;u--;0==u&&m(w)}}
var w=[],u=0;do w.push(void 0),u++,d(k.value).Xa(r(w.length-1),q),k=h.next();while(!k.done)})};
return b});
...
function Na(a){a.wb=void 0;a.getInstance=function(){return a.wb?a.wb:a.wb=new a}}
...
c.prototype=b.prototype;a.X=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Rq=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
function Ld(a){if(a.zb===vd)return a.toJSON();a=Id(a);return Array.isArray(a)?Kd(a,Ld,Md):a}
function Nd(a){if(!a)return a;if("object"===typeof a){if(fd(a))return new Uint8Array(a);if(a.zb===vd)return a.clone()}return a}
function Md(){}
...
function Rd(a,b,c){null==c?c=Cd:pd(c);return D(a,b,c)}
function Sd(a,b,c,d){Dd(a);(c=Td(a,c))&&c!==b&&null!=d&&D(a,c,void 0,!1);return D(a,b,d)}
function Td(a,b){for(var c=0,d=0;d<b.length;d++){var e=b[d];null!=Pd(a,e)&&(0!==c&&D(a,c,void 0,!1,!0),c=e)}return c}
function Ud(a,b,c,d){var e=d=void 0===d?!1:d,f=Pd(a,c,e);var g=!1;var h=null==f||"object"!==typeof f||(g=Array.isArray(f))||f.zb!==vd?g?new b(f):void 0:f;h!==f&&null!=h&&(D(a,c,h,e,!0),ld(h.A,nd(a.A)&-33));b=h;if(null==b)return b;qd(b.A)&&!qd(a.A)&&(b=b.Hb(),D(a,c,b,d));return b}
function Vd(a,b,c,d,e){e=void 0===e?!0:e;a.j||(a.j={});var f=a.j[c];d=Qd(a,c,2,d);var g=!!(nd(a.A)&16),h=qd(d);h=qd(a.A)||h;if(!f){f=[];for(var k=h,m=0;m<d.length;m++){var q=d[m];k=k||qd(q);var r=b,w=g,u=!1;u=void 0===u?!1:u;w=void 0===w?!1:w;q=Array.isArray(q)?new r(w?rd(q):q):u?new r:void 0;void 0!==q&&(f.push(q),h&&ld(q.A,2))}a.j[c]=f;td(d,!k)}b=h||e;e=qd(f);b&&!e&&(Object.isFrozen(f)&&(a.j[c]=f=f.slice()),ld(f,2),Object.freeze(f));!b&&e&&(a.j[c]=f=f.slice());return f}
function Wd(a,b,c,d){d=void 0===d?!1:d;var e=qd(a.A);b=Vd(a,b,c,d,e);a=Qd(a,c,0,void 0===d?!1:d);if(!(c=e)&&(c=a)){if(!a)throw Error("cannot check mutability state of non-array");c=!(nd(a)&8)}if(c){for(c=0;c<b.length;c++)(d=b[c])&&qd(d.A)&&!e&&(b[c]=b[c].Hb(),a[c]=b[c].A);td(a,!0)}return b}
function G(a,b,c,d){Dd(a);null!=d?Hd(d,b):d=void 0;return D(a,c,d)}
function Xd(a,b,c,d,e){Dd(a);null!=e?Hd(e,b):e=void 0;Sd(a,c,d,e)}
function Yd(a,b,c,d){Dd(a);if(null!=d){var e=pd([]);for(var f=!1,g=0;g<d.length;g++)e[g]=Hd(d[g],b).A,f=f||qd(e[g]);a.j||(a.j={});a.j[c]=d;td(e,!f)}else a.j&&(a.j[c]=void 0),e=Cd;return D(a,c,e)}
function Zd(a,b,c,d){Dd(a);var e=Vd(a,c,b,void 0,!1);c=null!=d?Hd(d,c):new c;a=Qd(a,b,2);e.push(c);a.push(c.A);qd(c.A)&&td(a,!1)}
function $d(a,b){return Pd(a,b)}
...
l.zb=vd;l.toString=function(){return this.A.toString()};
function ee(a,b){return Id(b)}
function fe(a,b){b.s&&(a.s=b.s.slice());var c=b.j;if(c){b=b.i;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length)for(f=Wd(a,e[0].constructor,g,f),g=0;g<Math.min(f.length,e.length);g++)fe(f[g],e[g])}else throw Error("unexpected object: type: "+Oa(e)+": "+e);}}}}
var ce;function ge(a,b,c,d,e,f){(a=a.j&&a.j[c])?(e=f.nb?pd(a.slice()):a,Yd(b,0<e.length?e[0].constructor:void 0,c,e)):(ed&&d instanceof Uint8Array?e=d.length?new id(new Uint8Array(d),gd):jd():(Array.isArray(d)&&(e?ld(d,2):d&&nd(d)&1&&f.nb?(e=Array.prototype.slice.call(d),od(e,(nd(d)|0)&-51),d=e):sd(d)),e=d),D(b,c,e))}
;function he(){be.apply(this,arguments)}
t(he,be);he.prototype.Hb=function(){return this};
if(Ed){var ie={};Object.defineProperties(he,(ie[Symbol.hasInstance]=Fd(function(){throw Error(void 0);}),ie))};function je(a){var b=this.i,c=this.j;return this.isRepeated?Wd(a,b,c,!0):Ud(a,b,c,!0)}
;function I(){he.apply(this,arguments)}
t(I,he);I.prototype.Hb=function(){if(qd(this.A)){var a={nb:!0};var b=qd(this.A);if(b&&!a.nb)throw Error("copyRepeatedFields must be true for frozen messages");b||sd(this.A);var c=new this.constructor;this.s&&(c.s=this.s.slice());for(var d=this.A,e=0;e<d.length;e++){var f=d[e];if(e===d.length-1&&Ad(f))for(var g in f){var h=+g;Number.isNaN(h)?Od(c)[g]=f[g]:ge(this,c,h,f[g],b,a)}else ge(this,c,e-this.m,f,b,a)}c.I=this;a=c}else a=this;return a};
if(Ed){var ke={};Object.defineProperties(I,(ke[Symbol.hasInstance]=Fd(Object[Symbol.hasInstance]),ke))};function le(a){this.Rb=a}
;function me(a,b,c){this.j=a;this.m=b;this.i=c||[];this.ya=new Map}
l=me.prototype;l.Cc=function(a){var b=Ja.apply(1,arguments),c=this.qb(b);c?c.push(new le(a)):this.qc(a,b)};
l.qc=function(a){this.ya.set(this.Yb(Ja.apply(1,arguments)),[new le(a)])};
l.qb=function(){var a=this.Yb(Ja.apply(0,arguments));return this.ya.has(a)?this.ya.get(a):void 0};
l.Pc=function(){var a=this.qb(Ja.apply(0,arguments));return a&&a.length?a[0]:void 0};
l.clear=function(){this.ya.clear()};
l.Yb=function(){var a=Ja.apply(0,arguments);return a?a.join(","):"key"};function ne(a,b){me.call(this,a,3,b)}
t(ne,me);ne.prototype.l=function(a){var b=Ja.apply(1,arguments),c=0,d=this.Pc(b);d&&(c=d.Rb);this.qc(c+a,b)};function oe(a,b){me.call(this,a,2,b)}
t(oe,me);oe.prototype.l=function(a){this.Cc(a,Ja.apply(1,arguments))};function pe(a){a&&"function"==typeof a.dispose&&a.dispose()}
...
ze.prototype.preventDefault=function(){ze.X.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var Ge="closure_listenable_"+(1E6*Math.random()|0);var He=0;function Ie(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.bb=e;this.key=++He;this.Ja=this.Wa=!1}
function Je(a){a.Ja=!0;a.listener=null;a.proxy=null;a.src=null;a.bb=null}
;function Ke(a){this.src=a;this.listeners={};this.i=0}
Ke.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.i++);var g=Le(a,b,d,e);-1<g?(b=a[g],c||(b.Wa=!1)):(b=new Ie(b,this.src,f,!!d,e),b.Wa=c,a.push(b));return b};
...
function Le(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.Ja&&f.listener==b&&f.capture==!!c&&f.bb==d)return e}return-1}
...
function Xe(a,b){if(a.Ja)a=!0;else{b=new ze(b,this);var c=a.listener,d=a.bb||a.src;a.Wa&&Ze(a);a=c.call(d,b)}return a}
...
return a[$e]}
;function af(){J.call(this);this.m=new Ke(this);this.zc=this;this.ka=null}
...
function bf(a,b){var c=a.ka;if(c){var d=[];for(var e=1;c;c=c.ka)d.push(c),++e}a=a.zc;c=b.type||b;"string"===typeof b?b=new te(b,a):b instanceof te?b.target=b.target||a:(e=b,b=new te(c,a),yb(b,e));e=!0;if(d)for(var f=d.length-1;!b.l&&0<=f;f--){var g=b.i=d[f];e=cf(g,c,!0,b)&&e}b.l||(g=b.i=a,e=cf(g,c,!0,b)&&e,b.l||(e=cf(g,c,!1,b)&&e));if(d)for(f=0;!b.l&&f<d.length;f++)g=b.i=d[f],e=cf(g,c,!1,b)&&e}
...
function cf(a,b,c,d){b=a.m.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.Ja&&g.capture==c){var h=g.listener,k=g.bb||g.src;g.Wa&&Me(a.m,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
yf.prototype.$goog_Thenable=!0;l=yf.prototype;l.jb=function(a,b){return Ef(this,null,a,b)};
l.catch=yf.prototype.jb;l.cancel=function(a){if(0==this.i){var b=new Ff(a);vf(function(){Gf(this,b)},this)}};
...
l.yd=function(a){this.i=0;zf(this,2,a)};
l.zd=function(a){this.i=0;zf(this,3,a)};
...
function Kf(a){a.s||(a.s=!0,vf(a.Nc,a))}
function Hf(a){var b=null;a.j&&(b=a.j,a.j=b.next,b.next=null);a.j||(a.m=null);return b}
l.Nc=function(){for(var a;a=Hf(this);)If(this,a,this.i,this.C);this.s=!1};
...
Za(Ff,ab);Ff.prototype.name="cancel";function Pf(a,b){af.call(this);this.l=a||1;this.j=b||y;this.o=Wa(this.wd,this);this.s=Date.now()}
Za(Pf,af);l=Pf.prototype;l.enabled=!1;l.ba=null;function Qf(a,b){a.l=b;a.ba&&a.enabled?(a.stop(),a.start()):a.ba&&a.stop()}
l.wd=function(){if(this.enabled){var a=Date.now()-this.s;0<a&&a<.8*this.l?this.ba=this.j.setTimeout(this.o,this.l-a):(this.ba&&(this.j.clearTimeout(this.ba),this.ba=null),bf(this,"tick"),this.enabled&&(this.stop(),this.start()))}};
...
;function Sf(a){this.C=a;this.i=new Map;this.s=new Set;this.l=0;this.m=100;this.flushInterval=3E4;this.j=new Pf(this.flushInterval);this.j.Z("tick",this.lb,!1,this);this.o=!1}
l=Sf.prototype;l.oc=function(a){this.o=a;this.m=1};
function Tf(a){a.j.enabled||a.j.start();a.l++;a.l>=a.m&&a.lb()}
l.lb=function(){var a=this.i.values();a=[].concat(ia(a)).filter(function(b){return b.ya.size});
a.length&&this.C.flush(a,this.o);Uf(a);this.l=0;this.j.enabled&&this.j.stop()};
l.Dc=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new ne(a,b))};
l.Ob=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new oe(a,b))};
function Vf(a,b){return a.s.has(b)?void 0:a.i.get(b)}
l.Ib=function(a){this.xc.apply(this,[a,1].concat(ia(Ja.apply(1,arguments))))};
l.xc=function(a,b){var c=Ja.apply(2,arguments),d=Vf(this,a);d&&d instanceof ne&&(d.l(b,c),Tf(this))};
l.kb=function(a,b){var c=Ja.apply(2,arguments),d=Vf(this,a);d&&d instanceof oe&&(d.l(b,c),Tf(this))};
function Uf(a){for(var b=0;b<a.length;b++)a[b].clear()}
;function Wf(a){this.i=a;this.i.Ob("/client_streamz/bg/fil",{pb:3,ob:"rk"})}
function Xf(a){this.i=a;this.i.Dc("/client_streamz/bg/fsc",{pb:3,ob:"rk"})}
function Yf(a){this.i=a;this.i.Ob("/client_streamz/bg/fsl",{pb:3,ob:"rk"})}
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var m,q;a();return{reset:a,update:c,digest:d,Jc:function(){for(var r=d(),w="",u=0;u<r.length;u++)w+="0123456789ABCDEF".charAt(Math.floor(r[u]/16))+"0123456789ABCDEF".charAt(r[u]%16);return w}}}
...
function mg(a){var b=jg();b.update(a);return b.Jc().toLowerCase()}
;var ng={};function og(a){this.i=a||{cookie:""}}
l=og.prototype;l.isEnabled=function(){if(!y.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{eb:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.jr;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.eb}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.i.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
l.remove=function(a,b,c){var d=void 0!==this.get(a);this.set(a,"",{eb:0,path:b,domain:c});return d};
l.tb=function(){return pg(this).keys};
...
Za(Jg,af);var Kg=/^https?$/i,Lg=["POST","PUT"],Mg=[];function Ng(a,b,c,d,e,f,g){var h=new Jg;Mg.push(h);b&&h.Z("complete",b);h.m.add("ready",h.Hc,!0,void 0,void 0);f&&(h.s=Math.max(0,f));g&&(h.W=g);h.send(a,c,d,e)}
l=Jg.prototype;l.Hc=function(){this.dispose();lb(Mg,this)};
l.send=function(a,b,c,d){if(this.B)throw Error("[goog.net.XhrIo] Object is active with another request="+this.T+"; newUri="+a);b=b?b.toUpperCase():"GET";this.T=a;this.o="";this.P=!1;this.j=!0;this.B=this.L?Ig(this.L):Ig(Gg);this.K=this.L?this.L.getOptions():Gg.getOptions();this.B.onreadystatechange=Wa(this.hc,this);try{this.getStatus(),this.R=!0,this.B.open(b,String(a),!0),this.R=!1}catch(g){this.getStatus();Og(this,g);return}a=c||"";c=new Map(this.headers);if(d)if(Object.getPrototypeOf(d)===Object.prototype)for(var e in d)c.set(e,
...
e=y.FormData&&a instanceof y.FormData;!(0<=eb(Lg,b))||d||e||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");b=p(c);for(d=b.next();!d.done;d=b.next())c=p(d.value),d=c.next().value,c=c.next().value,this.B.setRequestHeader(d,c);this.ca&&(this.B.responseType=this.ca);"withCredentials"in this.B&&this.B.withCredentials!==this.W&&(this.B.withCredentials=this.W);try{Pg(this),0<this.s&&(this.V=Qg(this.B),this.getStatus(),this.V?(this.B.timeout=this.s,this.B.ontimeout=Wa(this.tc,this)):
this.G=Rf(this.tc,this.s,this)),this.getStatus(),this.v=!0,this.B.send(a),this.v=!1}catch(g){this.getStatus(),Og(this,g)}};
function Qg(a){return Kc&&Vc()&&"number"===typeof a.timeout&&void 0!==a.ontimeout}
l.tc=function(){"undefined"!=typeof Ma&&this.B&&(this.o="Timed out after "+this.s+"ms, aborting",this.getStatus(),bf(this,"timeout"),this.abort(8))};
function Og(a,b){a.j=!1;a.B&&(a.l=!0,a.B.abort(),a.l=!1);a.o=b;Rg(a);Sg(a)}
function Rg(a){a.P||(a.P=!0,bf(a,"complete"),bf(a,"error"))}
l.abort=function(){this.B&&this.j&&(this.getStatus(),this.j=!1,this.l=!0,this.B.abort(),this.l=!1,bf(this,"complete"),bf(this,"abort"),Sg(this))};
l.D=function(){this.B&&(this.j&&(this.j=!1,this.l=!0,this.B.abort(),this.l=!1),Sg(this,!0));Jg.X.D.call(this)};
l.hc=function(){this.i()||(this.R||this.v||this.l?Tg(this):this.Yc())};
l.Yc=function(){Tg(this)};
function Tg(a){if(a.j&&"undefined"!=typeof Ma)if(a.K[1]&&4==Wg(a)&&2==a.getStatus())a.getStatus();else if(a.v&&4==Wg(a))Rf(a.hc,0,a);else if(bf(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Xg(a))bf(a,"complete"),bf(a,"success");else{try{var b=2<Wg(a)?a.B.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Rg(a)}}finally{Sg(a)}}}
function Sg(a,b){if(a.B){Pg(a);var c=a.B,d=a.K[0]?function(){}:null;
...
t(ih,I);var jh;jh=new function(a,b,c){this.j=a;this.fieldName=b;this.i=c;this.isRepeated=0;this.l=je}(175237375,{Xq:0},ih);function kh(a,b,c,d,e,f,g,h,k,m,q){af.call(this);var r=this;this.P="";this.l=[];this.Mb="";this.Nb=this.ra=-1;this.Ta=!1;this.K=this.o=null;this.G=0;this.Ac=1;this.timeoutMillis=0;this.ca=!1;af.call(this);this.Lb=b||function(){};
this.v=new lh(a,f);this.yc=d;this.Sa=q;this.Bc=Ya(ff,0,1);this.T=e||null;this.L=c||null;this.V=g||!1;this.pageId=k||null;this.logger=null;this.withCredentials=!h;this.Fa=f||!1;!this.Fa&&(65<=ac("Chromium")||45<=ac("Firefox")||12<=ac("Safari")||(Ec()||C("iPad")||C("iPod"))&&Fc());a=D(new bh,1,1);mh(this.v,a);this.s=new xg(1E4);this.j=new Pf(this.s.getValue());re(this,this.j);m=nh(this,m);Qe(this.j,"tick",m,!1,this);this.R=new Pf(6E5);re(this,this.R);Qe(this.R,"tick",m,!1,this);this.V||this.R.start();
this.Fa||(Qe(document,"visibilitychange",function(){"hidden"===document.visibilityState&&r.W()}),Qe(document,"pagehide",this.W,!1,this))}
...
function oh(a){a.T||(a.T=.01>a.Bc()?"https://www.google.com/log?format=json&hasfast=true":"https://play.google.com/log?format=json&hasfast=true");return a.T}
...
kh.prototype.flush=function(a,b){var c=this;if(0===this.l.length)a&&a();else if(this.ca)rh(this);else{var d=Date.now();if(this.Nb>d&&this.ra<d)b&&b("throttled");else{var e=sh(this.v,this.l,this.G);d={};var f=this.Lb();f&&(d.Authorization=f);var g=oh(this);this.L&&(d["X-Goog-AuthUser"]=this.L,g=wc(g,"authuser",this.L));this.pageId&&(d["X-Goog-PageId"]=this.pageId,g=wc(g,"pageId",this.pageId));if(f&&this.Mb===f)b&&b("stale-auth-token");else{this.l=[];this.j.enabled&&this.j.stop();this.G=0;var h=de(e),
k;this.K&&this.K.isSupported(h.length)&&(k=this.K.compress(h));var m={url:g,body:h,Fc:1,Db:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(u){c.s.reset();Qf(c.j,c.s.getValue());if(u){var A=null;try{var E=JSON.parse(u.replace(")]}'\n",""));A=new gh(E)}catch(F){}A&&(u=Number(ae(Pd(A,1),"-1")),0<u&&(c.ra=Date.now(),c.Nb=c.ra+u),A=jh.l(A))&&(A=ae(Pd(A,1),-1),-1!=A&&(c.Ta||ph(c,A)))}a&&a()},r=function(u,A){var E=Wd(e,ch,3),F=c.s;
F.i=Math.min(3E5,2*F.i);F.j=Math.min(3E5,F.i+Math.round(.2*(Math.random()-.5)*F.i));Qf(c.j,c.s.getValue());401===u&&f&&(c.Mb=f);void 0===A&&(A=500<=u&&600>u||401===u||0===u);A&&(c.l=E.concat(c.l),c.V||c.j.enabled||c.j.start());b&&b("net-send-failed",u)},w=function(){c.Sa?c.Sa.send(m,q,r):c.yc(m,q,r)};
k?k.then(function(u){m.Db["Content-Encoding"]="gzip";m.Db["Content-Type"]="application/binary";m.body=u;m.Fc=2;w()},function(){w()}):w()}}}};
...
function th(a,b){if(0!==a.l.length){var c=Ac(oh(a),"format");c=uc(c,"auth",a.Lb(),"authuser",a.L||"0");for(var d=0;10>d&&a.l.length;++d){var e=a.l.slice(0,32),f=sh(a.v,e,a.G);if(!b(c,f))break;a.G=0;a.l=a.l.slice(e.length)}a.j.enabled&&a.j.stop()}}
...
function mh(a,b){G(a.i,bh,1,b);Pd(b,1)||D(b,1,1);a.j||(b=uh(a),Pd(b,5)||D(b,5,a.locale));a.uach&&(b=uh(a),Ud(b,Zg,9)||G(b,Zg,9,a.uach))}
...
function uh(a){a=Ud(a.i,bh,1);var b=Ud(a,Yg,11);b||(b=new Yg,G(a,Yg,11,b));return b}
function sh(a,b,c){c=void 0===c?0:c;a=a.i.clone();var d=Date.now().toString();a=D(a,4,d);b=Yd(a,ch,3,b);c&&D(b,14,c);return b}
;function wh(a,b,c){Ng(a.url,function(d){d=d.target;if(Xg(d)){try{var e=d.B?d.B.responseText:""}catch(f){e=""}b(e)}else c(d.getStatus())},a.requestType,a.body,a.Db,a.timeoutMillis,a.withCredentials)}
;function xh(){this.l="https://play.google.com/log?format=json&hasfast=true";this.v=!1;this.o=wh;this.i=""}
;function yh(){var a=void 0===a?"":a;var b=void 0===b?"":b;var c=new xh;c.i="";""!=a&&(c.l=a);b&&(c.j=b);a=new kh(1828,c.K?c.K:ug,"0",c.o,c.l,c.v,!1,c.R,void 0,void 0,c.s?c.s:void 0);c.I&&mh(a.v,c.I);if(c.j){b=c.j;var d=uh(a.v);D(d,7,b)}c.m&&(a.K=c.m);c.i&&(a.P=c.i);c.C&&((b=c.C)?(a.o||(a.o=new vg),b=de(b),D(a.o,4,b)):a.o&&D(a.o,4,void 0,!1));c.L&&(b=c.L,a.o||(a.o=new vg),Rd(a.o,2,b));c.G&&(b=c.G,a.Ta=!0,ph(a,b));c.P&&vh(a.v,c.P);this.i=a}
yh.prototype.flush=function(a){var b=a||[];if(b.length){a=new gg;for(var c=[],d=0;d<b.length;d++){var e=b[d],f=e;var g=new Zf;g=D(g,1,f.j);for(var h=f,k=[],m=0;m<h.i.length;m++)k.push(h.i[m].ob);g=Rd(g,3,k);h=[];k=[];m=p(f.ya.keys());for(var q=m.next();!q.done;q=m.next())k.push(q.value.split(","));for(m=0;m<k.length;m++){q=k[m];var r=f.m;for(var w=f.qb(q)||[],u=[],A=0;A<w.length;A++){var E=w[A];E=E&&E.Rb;var F=new dg;switch(r){case 3:Sd(F,1,fg,Number(E));break;case 2:Sd(F,2,fg,Number(E))}u.push(F)}r=
u;for(w=0;w<r.length;w++){u=r[w];A=new ag;u=G(A,dg,2,u);A=q;E=[];F=f;for(var O=[],N=0;N<F.i.length;N++)O.push(F.i[N].pb);F=O;for(O=0;O<F.length;O++){N=F[O];var R=A[O],ca=new cg;switch(N){case 3:Sd(ca,1,eg,String(R));break;case 2:Sd(ca,2,eg,Number(R));break;case 1:Sd(ca,3,eg,"true"==R)}E.push(ca)}Yd(u,cg,1,E);h.push(u)}}Yd(g,ag,4,h);c.push(g);e.clear()}Yd(a,Zf,1,c);b=this.i;a instanceof ch?b.log(a):(c=new ch,a=de(a),a=D(c,8,a),b.log(a));this.i.flush()}};function zh(){this.o=Ah();this.s=new yh;this.i=new Sf(this.s);this.m=new Wf(this.i);this.j=new Xf(this.i);this.l=new Yf(this.i);this.Ba=window.document.location.hostname}
...
;function Ch(a){var b=this;this.Za=!1;if(a.dd){var c;this.sa=null!=(c=a.sa)?c:new zh}c=a.program;a=a.globalName;var d=new Bh;this.j=d.promise;this.ud=p((0,y[a].a)(c,function(e,f){Promise.resolve().then(function(){var g;if(null!=(g=b.sa)){var h=Ah()-g.o;g.m.i.kb("/client_streamz/bg/fil",h,g.Ba)}d.resolve({Ec:e,rd:f})})},!0)).next().value;
this.qd=d.promise.then(function(){})}
Ch.prototype.snapshot=function(a){var b=this;if(this.Za)throw Error("Already disposed");var c=Ah(),d;null!=(d=this.sa)&&d.j.i.Ib("/client_streamz/bg/fsc",d.Ba);return this.j.then(function(e){var f=e.Ec;return new Promise(function(g){f(function(h){var k;if(null!=(k=b.sa)){var m=Ah()-c;k.l.i.kb("/client_streamz/bg/fsl",m,k.Ba)}g(h)},[a.Tb,
a.sd])})})};
Ch.prototype.dispose=function(){var a;null!=(a=this.sa)&&a.i.lb();this.Za=!0;this.j.then(function(b){(b=b.rd)&&b()})};
Ch.prototype.i=function(){return this.Za};var Dh=window;Db("csi.gstatic.com");Db("googleads.g.doubleclick.net");Db("partner.googleadservices.com");Db("pubads.g.doubleclick.net");Db("securepubads.g.doubleclick.net");Db("tpc.googlesyndication.com");/*
...
return a}
var Ih={Nd:"allow-forms",Od:"allow-modals",Pd:"allow-orientation-lock",Qd:"allow-pointer-lock",Rd:"allow-popups",Sd:"allow-popups-to-escape-sandbox",Td:"allow-presentation",Ud:"allow-same-origin",Vd:"allow-scripts",Wd:"allow-top-navigation",Xd:"allow-top-navigation-by-user-activation"},Kh=db(function(){return Jh()});
...
;var Yh={ki:"EMBEDDED_PLAYER_MODE_UNKNOWN",hi:"EMBEDDED_PLAYER_MODE_DEFAULT",ji:"EMBEDDED_PLAYER_MODE_PFP",ii:"EMBEDDED_PLAYER_MODE_PFL"},Zh={zq:"WEB_DISPLAY_MODE_UNKNOWN",uq:"WEB_DISPLAY_MODE_BROWSER",xq:"WEB_DISPLAY_MODE_MINIMAL_UI",yq:"WEB_DISPLAY_MODE_STANDALONE",wq:"WEB_DISPLAY_MODE_FULLSCREEN"};function $h(){this.data_=[];this.i=-1}
...
l.forEach=function(a,b){for(var c=this.tb(),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
...
function vi(a,b,c,d){if(b=a.l[b]){var e=a.j;(b=b.find(function(f){return e[f+1]==c&&e[f+2]==d}))&&a.Ea(b)}}
...
t(Ni,I);Ni.prototype.getKey=function(){return Pd(this,1)};
Ni.prototype.getValue=function(){return $d(this,2===Td(this,Oi)?2:-1)};
Ni.prototype.setValue=function(a){return Sd(this,2,Oi,a)};
...
t(Ti,I);Ti.prototype.getPlayerType=function(){return Pd(this,36)};
...
t($i,I);$i.prototype.C=function(a){G(this,Ti,1,a)};
...
t(ij,I);ij.prototype.getKey=function(){return ae(Pd(this,1),"")};
ij.prototype.getValue=function(){return ae(Pd(this,2),"")};
...
t(mj,I);mj.prototype.getMessage=function(){return ae(Pd(this,1),"")};function nj(a){I.call(this,a)}
...
t(vj,I);function wj(a,b){G(a,tj,1,b)}
vj.prototype.l=function(a){D(this,2,a)};
function xj(a){I.call(this,a)}
t(xj,I);function yj(a,b){G(a,tj,1,b)}
;function zj(a){I.call(this,a,-1,Aj)}
t(zj,I);zj.prototype.l=function(a){D(this,1,a)};
function Bj(a,b){G(a,tj,2,b)}
var Aj=[3];function Cj(a){I.call(this,a)}
t(Cj,I);Cj.prototype.l=function(a){D(this,1,a)};function Dj(a){I.call(this,a)}
t(Dj,I);Dj.prototype.l=function(a){D(this,1,a)};function Ej(a){I.call(this,a)}
t(Ej,I);Ej.prototype.l=function(a){D(this,1,a)};function Fj(a){I.call(this,a)}
t(Fj,I);Fj.prototype.l=function(a){D(this,1,a)};function Gj(a){I.call(this,a)}
t(Gj,I);function Hj(a){I.call(this,a)}
t(Hj,I);function Ij(a){I.call(this,a,-1,Jj)}
t(Ij,I);Ij.prototype.getPlayerType=function(){var a=Pd(this,7);return null==a?0:a};
Ij.prototype.setVideoId=function(a){return D(this,19,a)};
function Kj(a,b){Zd(a,68,Lj,b)}
function Lj(a){I.call(this,a)}
t(Lj,I);Lj.prototype.getId=function(){return ae(Pd(this,2),"")};
var Jj=[83,68];function Mj(a){I.call(this,a)}
t(Mj,I);function Nj(a){I.call(this,a)}
t(Nj,I);function Oj(a){I.call(this,a)}
t(Oj,I);function Pj(a){I.call(this,a,442)}
t(Pj,I);
...
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441];var Rj={lj:0,Wi:1,cj:2,dj:4,ij:8,ej:16,fj:32,kj:64,jj:128,Yi:256,aj:512,hj:1024,Zi:2048,bj:4096,Xi:8192,gj:16384};function Sj(a){I.call(this,a)}
t(Sj,I);function Tj(a){I.call(this,a)}
t(Tj,I);Tj.prototype.setVideoId=function(a){return Sd(this,1,Uj,a)};
Tj.prototype.getPlaylistId=function(){return $d(this,2===Td(this,Uj)?2:-1)};
var Uj=[1,2];function Vj(a){I.call(this,a,-1,Wj)}
t(Vj,I);var Wj=[3];var Xj=new bj("webPlayerShareEntityServiceEndpoint");var Yj=new bj("playlistEditEndpoint");var tk=new bj("modifyChannelNotificationPreferenceEndpoint");var uk=new bj("unsubscribeEndpoint");var vk=new bj("subscribeEndpoint");function wk(a,b){1<b.length?a[b[0]]=b[1]:1===b.length&&Object.assign(a,b[0])}
...
;var Pk=/^[\w.]*$/,Qk={q:!0,search_query:!0};function Rk(a,b){b=a.split(b);for(var c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=Sk(f[0]||""),h=Sk(f[1]||"");g in c?Array.isArray(c[g])?mb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(r){var k=r,m=f[0],q=String(Rk);k.args=[{key:m,value:f[1],query:a,method:Tk==q?"unchanged":q}];Qk.hasOwnProperty(m)||Lk(k)}}return c}
...
null==(r=Dh.screen)?void 0:r.availWidth;var w;e.u_cd=null==(w=Dh.screen)?void 0:w.colorDepth}catch(fa){}h=b.i;try{var u=h.screenX;var A=h.screenY}catch(fa){}try{var E=h.outerWidth;var F=h.outerHeight}catch(fa){}try{var O=h.innerWidth;var N=h.innerHeight}catch(fa){}try{var R=h.screenLeft;var ca=h.screenTop}catch(fa){}try{O=h.innerWidth,N=h.innerHeight}catch(fa){}try{var W=h.screen.availWidth;var ob=h.screen.availTop}catch(fa){}u=[R,ca,u,A,W,ob,E,F,O,N];try{var Xa=(b.i.top||window).document,ma="CSS1Compat"==
Xa.compatMode?Xa.documentElement:Xa.body;var H=(new hf(ma.clientWidth,ma.clientHeight)).round()}catch(fa){H=new hf(-12245933,-12245933)}Xa=H;H={};var la=void 0===la?y:la;ma=new $h;la.SVGElement&&la.document.createElementNS&&ma.set(0);A=Lh();A["allow-top-navigation-by-user-activation"]&&ma.set(1);A["allow-popups-to-escape-sandbox"]&&ma.set(2);la.crypto&&la.crypto.subtle&&ma.set(3);la.TextDecoder&&la.TextEncoder&&ma.set(4);la=ai(ma);H.bc=la;H.bih=Xa.height;H.biw=Xa.width;H.brdim=u.join();b=b.j;b=(H.vis=
...
return Xk(a,f||{},!1)}
function kl(a,b){var c=b.format||"JSON";a=ll(a,b);var d=ml(a,b),e=!1,f=nl(a,function(k){if(!e){e=!0;h&&el(h);var m=cl(k),q=null,r=400<=k.status&&500>k.status,w=500<=k.status&&600>k.status;if(m||r||w)q=ol(a,c,k,b.convertToSafeHtml);if(m)a:if(k&&204==k.status)m=!0;else{switch(c){case "XML":m=0==parseInt(q&&q.return_code,10);break a;case "RAW":m=!0;break a}m=!!q}q=q||{};r=b.context||y;m?b.onSuccess&&b.onSuccess.call(r,k,q):b.onError&&b.onError.call(r,k,q);b.onFinish&&b.onFinish.call(r,k,q)}},b.method,
...
;function ul(a,b,c,d,e){qg.set(""+a,b,{eb:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
function vl(a,b,c){qg.remove(""+a,void 0===b?"/":b,void 0===c?"youtube.com":c)}
function wl(){if(!qg.isEnabled())return!1;if(!qg.isEmpty())return!0;qg.set("TESTCOOKIESENABLED","1",{eb:60});if("1"!==qg.get("TESTCOOKIESENABLED"))return!1;qg.remove("TESTCOOKIESENABLED");return!0}
...
function Rl(a){var b=new $i,c=new Ti;D(c,1,a.dc);D(c,2,a.cc);D(c,16,a.Rc);D(c,17,a.innertubeContextClientVersion);if(a.vb){var d=a.vb,e=new Pi;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);G(c,Pi,62,e)}(d=y.devicePixelRatio)&&1!=d&&D(c,65,d);d=Fk();""!==d&&D(c,54,d);d=Gk();if(0<d.length){e=new Vi;for(var f=0;f<d.length;f++){var g=new Ni;D(g,1,d[f].key);g.setValue(d[f].value);Zd(e,15,Ni,
...
function Nl(a,b,c){a=a.ac;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=Ud(b,Qi,96)||new Qi;var d=tl();d=Object.keys(Zh).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);G(b,Qi,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=tl())}
...
function Pl(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=Ud(b,Pi,62))?d:new Pi;D(c,6,a.appInstallData);G(b,Pi,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
...
function Sl(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Qq||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Pq:b=ug([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new Em("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",ic:e.name})];e.level="WARNING";return e}
...
Nm.all=function(a){return new Nm(new Mm(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={xa:0};f.xa<a.length;f={xa:f.xa},++f.xa)Nm.resolve(a[f.xa]).then(function(g){return function(h){d[g.xa]=h;e--;0===e&&b(d)}}(f)).catch(function(g){c(g)})}))};
...
l.update=function(a){return Tm(this.cursor.update(a))};function kn(a,b,c){return new Promise(function(d,e){function f(){w||(w=new Vm(g.result,{closed:r}));return w}
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,m=c.vd,q=c.upgrade,r=c.closed,w;g.addEventListener("upgradeneeded",function(u){try{if(null===u.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");u.dataLoss&&"none"!==u.dataLoss&&tm("IDB_DATA_CORRUPTED",{reason:u.dataLossMessage||"unknown reason",dbName:xm(a)});var A=f(),E=new $m(g.transaction);
...
function rn(a){function b(){var f,g,h,k,m,q,r,w,u,A;return x(function(E){switch(E.i){case 1:return g=null!=(f=Error().stack)?f:"",ya(E,2),v(E,a.l(a.name,a.options.version,d),4);case 4:h=E.j;for(var F=a.options,O=[],N=p(Object.keys(F.Ia)),R=N.next();!R.done;R=N.next()){R=R.value;var ca=F.Ia[R],W=void 0===ca.ed?Number.MAX_VALUE:ca.ed;!(h.i.version>=ca.mb)||h.i.version>=W||h.i.objectStoreNames.contains(R)||O.push(R)}k=O;if(0===k.length){E.u(5);break}m=Object.keys(a.options.Ia);q=h.objectStoreNames();
...
a.m=!1,pn(a,u);return E.return(w);case 10:throw c(),r instanceof Error&&!M("ytidb_async_stack_killswitch")&&(r.stack=r.stack+"\n"+g.substring(g.indexOf("\n")+1)),Im(r,a.name,"",null!=(A=a.options.version)?A:-1);}})}
function c(){a.i===e&&(a.i=void 0)}
if(!a.m)throw pn(a);if(a.i)return a.i;var d={blocking:function(f){f.close()},
closed:c,vd:c,upgrade:a.options.upgrade};var e=b();a.i=e;return a.i}
;var sn=new on("YtIdbMeta",{Ia:{databases:{mb:1}},upgrade:function(a,b){b(1)&&Xm(a,"databases",{keyPath:"actualName"})}});
...
;function Qn(a){this.Va=this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.Aa=function(){};
this.now=Date.now;this.Ha=!1;var b;this.sc=null!=(b=a.sc)?b:100;var c;this.nc=null!=(c=a.nc)?c:1;var d;this.lc=null!=(d=a.lc)?d:2592E6;var e;this.jc=null!=(e=a.jc)?e:12E4;var f;this.mc=null!=(f=a.mc)?f:5E3;var g;this.H=null!=(g=a.H)?g:void 0;this.ab=!!a.ab;var h;this.Ya=null!=(h=a.Ya)?h:.1;var k;this.gb=null!=(k=a.gb)?k:10;a.handleError&&(this.handleError=a.handleError);a.Aa&&(this.Aa=a.Aa);a.Ha&&(this.Ha=a.Ha);a.Va&&(this.Va=a.Va);this.J=a.J;this.Y=a.Y;this.O=a.O;this.N=a.N;this.ia=a.ia;this.Bb=
a.Bb;this.Ab=a.Ab;Rn(this)&&(!this.J||this.J("networkless_logging"))&&Sn(this)}
function Sn(a){Rn(a)&&!a.Ha&&(a.i=!0,a.ab&&Math.random()<=a.Ya&&a.O.Gc(a.H),Tn(a),a.N.M()&&a.Ma(),a.N.Z(a.Bb,a.Ma.bind(a)),a.N.Z(a.Ab,a.Pb.bind(a)))}
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.O.za(d.id,c.H):e=!0;c.N.ha&&c.J&&c.J("vss_network_hint")&&c.N.ha(!0);f(g,h)};
this.ia(d.url,d.options);this.O.set(d,this.H).then(function(g){d.id=g;e&&c.O.za(d.id,c.H)}).catch(function(g){Vn(c,g)})}else this.ia(a,b)};
l.Ma=function(){var a=this;if(!Rn(this))throw Jm("throttleSend");this.j||(this.j=this.Y.S(function(){var b;return x(function(c){if(1==c.i)return v(c,a.O.Zb("NEW",a.H),2);if(3!=c.i)return b=c.j,b?v(c,Un(a,b),3):(a.Pb(),c.return());a.j&&(a.j=0,a.Ma());c.i=0})},this.sc))};
l.Pb=function(){this.Y.ea(this.j);this.j=0};
function Un(a,b){var c,d;return x(function(e){switch(e.i){case 1:if(!Rn(a))throw c=Jm("immediateSend"),c;if(void 0===b.id){e.u(2);break}return v(e,a.O.Wc(b.id,a.H),3);case 3:(d=e.j)?b=d:a.Aa(Error("The request cannot be found in the database."));case 2:if(Wn(a,b,a.lc)){e.u(4);break}a.Aa(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return v(e,a.O.za(b.id,a.H),5);case 5:return e.return();case 4:b.skipRetry||(b=Xn(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
...
b.options.onError=function(e,f){var g,h,k;return x(function(m){switch(m.i){case 1:g=Yn(f);if(!(a.J&&a.J("nwl_consider_error_code")&&g||a.J&&!a.J("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.gb)){m.u(2);break}if(!a.N.Ka){m.u(3);break}return v(m,a.N.Ka(),3);case 3:if(a.N.M()){m.u(2);break}c(e,f);if(!a.J||!a.J("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.u(6);break}return v(m,a.O.Eb(b.id,a.H,!1),6);case 6:return m.return();case 2:if(a.J&&a.J("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.gb)return m.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){m.u(8);break}return b.sendCount<a.nc?v(m,a.O.Eb(b.id,a.H),12):v(m,a.O.za(b.id,a.H),8);case 12:a.Y.S(function(){a.N.M()&&a.Ma()},a.mc);
case 8:c(e,f),m.i=0}})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){var g;return x(function(h){if(1==h.i)return void 0===(null==(g=b)?void 0:g.id)?h.u(2):v(h,a.O.za(b.id,a.H),2);a.N.ha&&a.J&&a.J("vss_network_hint")&&a.N.ha(!0);d(e,f);h.i=0})};
return b}
function Wn(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function Tn(a){if(!Rn(a))throw Jm("retryQueuedRequests");a.O.Zb("QUEUED",a.H).then(function(b){b&&!Wn(a,b,a.jc)?a.Y.S(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.u(2):v(c,a.O.Eb(b.id,a.H),2);Tn(a);c.i=0})}):a.N.M()&&a.Ma()})}
function Vn(a,b){a.wc&&!a.N.M()?a.wc(b):a.handleError(b)}
function Rn(a){return!!a.H||a.Va}
...
;var Ao={},Bo=oo("ServiceWorkerLogsDatabase",{Ia:(Ao.SWHealthLog={mb:1},Ao),Gb:!0,upgrade:function(a,b){b(1)&&Xm(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")){var r=!0;break b}}catch(w){}r=!1}b=r?!0:!1}else b=!1;b||Io(a)}}
...
t(Oo,af);function Po(){if(!Oo.i){var a=B("yt.networkStatusManager.instance")||new Oo;z("yt.networkStatusManager.instance",a);Oo.i=a}return Oo.i}
l=Oo.prototype;l.M=function(){return this.j.M()};
l.ha=function(a){this.j.j=a};
l.Qc=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
l.Kc=function(){this.l=!0};
l.Z=function(a,b){return this.j.Z(a,b)};
l.Ka=function(a){a=Uh(this.j,a);a.then(function(b){M("use_cfr_monitor")&&Ko().requestComplete("generate_204",b)});
return a};
Oo.prototype.sendNetworkCheckRequest=Oo.prototype.Ka;Oo.prototype.listen=Oo.prototype.Z;Oo.prototype.enableErrorFlushing=Oo.prototype.Kc;Oo.prototype.getWindowStatus=Oo.prototype.Qc;Oo.prototype.networkStatusHint=Oo.prototype.ha;Oo.prototype.isNetworkAvailable=Oo.prototype.M;Oo.getInstance=Po;function Qo(a){a=void 0===a?{}:a;af.call(this);var b=this;this.j=this.s=0;this.l=Po();var c=B("yt.networkStatusManager.instance.listen").bind(this.l);c&&(a.ib?(this.ib=a.ib,c("networkstatus-online",function(){Ro(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Ro(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){bf(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){bf(b,"publicytnetworkstatus-offline")})))}
t(Qo,af);Qo.prototype.M=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.l)():!0};
Qo.prototype.ha=function(a){var b=B("yt.networkStatusManager.instance.networkStatusHint").bind(this.l);b&&b(a)};
Qo.prototype.Ka=function(a){var b=this,c;return x(function(d){c=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.l);return M("skip_network_check_if_cfr")&&Ko().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.ha((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.M())})):c?d.return(c(a)):d.return(!0)})};
function Ro(a,b){a.ib?a.j?(Xh.ea(a.s),a.s=Xh.S(function(){a.o!==b&&(bf(a,b),a.o=b,a.j=P())},a.ib-(P()-a.j))):(bf(a,b),a.o=b,a.j=P()):bf(a,b)}
;var So;function To(){Qn.call(this,{O:{Gc:yo,za:xo,Zb:uo,Wc:vo,Eb:wo,set:so},N:Uo(),handleError:Kk,Aa:Lk,ia:Vo,now:P,wc:No,Y:gm(),Bb:"publicytnetworkstatus-online",Ab:"publicytnetworkstatus-offline",ab:!0,Ya:.1,gb:Ek("potential_esf_error_limit",10),J:M,Ha:!(um()&&Wo())});this.l=new Bh;M("networkless_immediately_drop_all_requests")&&zo();Pn("LogsDatabaseV2")}
t(To,Qn);function Xo(){var a=B("yt.networklessRequestController.instance");a||(a=new To,z("yt.networklessRequestController.instance",a),M("networkless_logging")&&En().then(function(b){a.H=b;Sn(a);a.l.resolve();a.ab&&Math.random()<=a.Ya&&a.H&&Do(a.H);M("networkless_immediately_drop_sw_health_store")&&Yo(a)}));
return a}
...
function Uo(){So||(So=new Qo({Vc:!0,Lc:!0}));return So}
...
function gp(){if(M("use_new_nwl"))return Uo();cp||(cp=new Qo({Vc:!0,Lc:!0}));return cp}
...
c.onFetchSuccess=function(N,R){Zl(E);O(N,R)}}try{A&&d.retry&&!d.fc.bypassNetworkless?(g.method="POST",d.fc.writeThenSend?M("use_new_nwl_wts")?Xo().writeThenSend(u,g):kp(u,g):M("use_new_nwl_saw")?Xo().sendAndWrite(u,g):op(u,g)):M("web_all_payloads_via_jspb")?kl(u,g):(g.method="POST",g.postParams||(g.postParams={}),kl(u,g))}catch(N){if("InvalidAccessError"==N.name)E&&(Zl(E),E=0),Lk(Error("An extension is blocking network request."));
...
;var nq=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function oq(a){this.G=a;this.j=null;this.o=0;this.v=null;this.s=0;this.l=[];for(a=0;4>a;a++)this.l.push(0);this.m=0;this.L=lq(window,"mousemove",Wa(this.P,this));a=Wa(this.K,this);"function"===typeof a&&(a=Jk(a));this.R=window.setInterval(a,25)}
...
function qq(a){var b=void 0===a?{}:a;a=void 0===b.bd?!1:b.bd;b=void 0===b.Mc?!0:b.Mc;if(null==B("_lact",window)){var c=parseInt(L("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&rq();lq(document,"keydown",rq);lq(document,"keyup",rq);lq(document,"mousedown",rq);lq(document,"mouseup",rq);a?lq(window,"touchmove",function(){sq("touchmove",200)},{passive:!0}):(lq(window,"resize",function(){sq("resize",200)}),b&&lq(window,"scroll",function(){sq("scroll",200)}));
...
Eq.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=p(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=p(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?(b.push(e.payload),this.i[Fq(e.keys)]--):c.push(e)}this.store=c;a=Gq(this,a);a=p(a);for(c=a.next();!c.done;c=a.next())c=c.value,0<this.i[c]&&Lk(new Q("Transport IMS did not fully extract entries for key:",{sequence:c,er:b.length,dr:this.i[c]}));return b};
...
function Yq(a,b){var c="";if(a.Ga)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Tj;c.videoId?d.setVideoId(c.videoId):c.playlistId&&Sd(d,2,Uj,c.playlistId);Tq[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Sq[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
...
a?Nq.j=b:Mq.j=b}
function dr(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(P()),h=a.size,k={};a=p(a);for(var m=a.next();!m.done;k={Pa:k.Pa,oa:k.oa,Ca:k.Ca,Ra:k.Ra,Qa:k.Qa},m=a.next()){var q=p(m.value);m=q.next().value;q=q.next().value;k.oa=wb({context:Ml(b.config_||Ll())});if(!Pa(q)&&!M("throw_err_when_logevent_malformed_killswitch")){d();break}k.oa.events=q;(q=Sq[m])&&gr(k.oa,m,q);delete Sq[m];k.Ca="visitorOnlyApprovedKey"===m;hr(k.oa,g,k.Ca);ir(e);k.Ra=function(){h--;h||c()};
k.Pa=0;k.Qa=function(r){return function(){r.Pa++;if(e.bypassNetworkless&&M("log_errors_through_nwl_on_retry")&&1===r.Pa)try{am(b,"log_event",r.oa,jr({writeThenSend:!0},r.Ca,r.Ra,r.Qa,f)),Pq=!1}catch(w){Kk(w),d()}h--;h||c()}}(k);
try{am(b,"log_event",k.oa,jr(e,k.Ca,k.Ra,k.Qa,f)),Pq=!1}catch(r){Kk(r),d()}}}
function fr(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(P()),g=a.size,h=new Map([].concat(ia(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new Vj;var r=Rl(b.config_||Ll());G(k,$i,1,r);q=q?kr(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())Zd(k,3,Pj,r.value);(q=Tq[m])&&lr(k,m,q);delete Tq[m];m="visitorOnlyApprovedKey"===m;mr(k,f,m);ir(d);k=de(k);m=jr(d,m,function(){g--;g||c()},function(){g--;
g||c()},e);
...
function jr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,fc:a,Ga:b,Sq:!!e,headers:{},postBodyFormat:"",postBody:""};nr()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
...
function lr(a,b,c){if($d(c,1===Td(c,Uj)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;G(a,Tj,4,c);a=Ud(a,$i,1)||new $i;c=Ud(a,Yi,3)||new Yi;var e=new Xi;e.setToken(b);D(e,1,d);Zd(c,12,Xi,e);G(a,Yi,3,c)}
...
function qr(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;M("enable_unknown_lact_fix_on_html5")&&qq();a=tq();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.aa&&(a=e.context,b=d.aa,b={index:rr(b),groupKey:b},a.sequence=b,d.Wb&&delete pr[d.aa]);(d.oc?cr:Wq)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,Ga:d.Ga},c)}
function sr(a){ar(void 0,void 0,void 0===a?!1:a)}
function rr(a){pr[a]=a in pr?pr[a]+1:0;return pr[a]}
;var tr=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",tr);function ur(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||P());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=tq();d=new Oj;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.aa){e=c.aa;var f=rr(e),g=new Nj;D(g,2,f);D(g,1,e);G(d,Nj,3,g);c.Wb&&delete tr[c.aa]}G(a,Oj,33,d);(c.oc?er:$q)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,Ga:c.Ga},b)}
;function vr(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);ur(a,c?null:sp,b)}
;function wr(a,b){var c=new Pj;Xd(c,Ej,72,Qj,a);vr(c,b)}
function xr(a,b,c){var d=new Pj;Xd(d,Dj,73,Qj,a);c?ur(d,c,b):vr(d,b)}
function yr(a,b,c){var d=new Pj;Xd(d,Cj,78,Qj,a);c?ur(d,c,b):vr(d,b)}
function zr(a,b,c){var d=new Pj;Xd(d,Fj,208,Qj,a);c?ur(d,c,b):vr(d,b)}
function Ar(a,b,c){var d=new Pj;Xd(d,vj,156,Qj,a);c?ur(d,c,b):vr(d,b)}
function Br(a,b,c){var d=new Pj;Xd(d,zj,215,Qj,a);c?ur(d,c,b):vr(d,b)}
function Cr(a,b,c){var d=new Pj;Xd(d,uj,111,Qj,a);c?ur(d,c,b):vr(d,b)}
...
;var Dr=[{yb:function(a){return"Cannot read property '"+a.key+"'"},
fb:{Error:[{regexp:/(Permission denied) to access property "([^']+)"/,groups:["reason","key"]}],TypeError:[{regexp:/Cannot read property '([^']+)' of (null|undefined)/,groups:["key","value"]},{regexp:/\u65e0\u6cd5\u83b7\u53d6\u672a\u5b9a\u4e49\u6216 (null|undefined) \u5f15\u7528\u7684\u5c5e\u6027\u201c([^\u201d]+)\u201d/,groups:["value","key"]},{regexp:/\uc815\uc758\ub418\uc9c0 \uc54a\uc74c \ub610\ub294 (null|undefined) \ucc38\uc870\uc778 '([^']+)' \uc18d\uc131\uc744 \uac00\uc838\uc62c \uc218 \uc5c6\uc2b5\ub2c8\ub2e4./,
...
fb:{TypeError:[{regexp:/(?:([^ ]+)?\.)?([^ ]+) is not a function/,groups:["base","key"]},{regexp:/([^ ]+) called on (null or undefined)/,groups:["key","value"]},{regexp:/Object (.*) has no method '([^ ]+)'/,groups:["base","key"]},{regexp:/Object doesn't support property or method '([^ ]+)'/,groups:["key"]},{regexp:/\u30aa\u30d6\u30b8\u30a7\u30af\u30c8\u306f '([^']+)' \u30d7\u30ed\u30d1\u30c6\u30a3\u307e\u305f\u306f\u30e1\u30bd\u30c3\u30c9\u3092\u30b5\u30dd\u30fc\u30c8\u3057\u3066\u3044\u307e\u305b\u3093/,
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}},{yb:function(a){return a.key+" is not defined"},
fb:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Fr={ma:[],la:[{callback:Er,weight:500}]};function Er(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=Qr)){var m=Tr,q=ue(a),r=q.message||"Unknown Error",w=q.name||"UnknownError",u=q.stack||a.j||"Not available";if(u.startsWith(w+": "+r)){var A=u.split("\n");A.shift();u=A.join("\n")}var E=q.lineNumber||"Not available",F=q.fileName||"Not available",O=u,N=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var R=0;R<a.args.length&&!(N=Mr(a.args[R],"params."+R,g,N),500<=N);R++);else if(a.hasOwnProperty("params")&&
a.params){var ca=a.params;if("object"===typeof a.params)for(var W in ca){if(ca[W]){var ob="params."+W,Xa=Or(ca[W]);g[ob]=Xa;N+=ob.length+Xa.length;if(500<N)break}}else g.params=Or(ca)}if(m.length)for(var ma=0;ma<m.length&&!(N=Mr(m[ma],"params.context."+ma,g,N),500<=N);ma++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:r,name:w,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},la=Number(a.columnNumber);isNaN(la)||(H.lineNumber=H.lineNumber+
":"+la);if("IGNORED"===a.level)var fa=0;else a:{for(var Be=Ir(),Ce=p(Be.ma),wd=Ce.next();!wd.done;wd=Ce.next()){var oa=wd.value;if(H.message&&H.message.match(oa.br)){fa=oa.weight;break a}}for(var xp=p(Be.la),Zj=xp.next();!Zj.done;Zj=xp.next()){var yp=Zj.value;if(yp.callback(H)){fa=yp.weight;break a}}fa=1}H.sampleWeight=fa;for(var zp=p(Dr),ak=zp.next();!ak.done;ak=zp.next()){var bk=ak.value;if(bk.fb[H.name])for(var Ap=p(bk.fb[H.name]),ck=Ap.next();!ck.done;ck=Ap.next()){var Bp=ck.value,Ug=H.message.match(Bp.regexp);
if(Ug){H.params["params.error.original"]=Ug[0];for(var dk=Bp.groups,Cp={},xd=0;xd<dk.length;xd++)Cp[dk[xd]]=Ug[xd+1],H.params["params.error."+dk[xd]]=Ug[xd+1];H.message=bk.yb(Cp);break}}}H.params||(H.params={});var Dp=Ir();H.params["params.errorServiceSignature"]="msg="+Dp.ma.length+"&cb="+Dp.la.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Pr.has(H.message)){if("ERROR"===h){Jr.qa("handleError",H);if(M("record_app_crashed_web")&&0===Sr&&1===H.sampleWeight)if(Sr++,M("errors_via_jspb")){var ek=new rj;D(ek,1,1);if(!M("report_client_error_with_app_crash_ks")){var Ep=new mj;D(Ep,1,H.message);var Fp=new nj;G(Fp,mj,3,Ep);var Gp=new oj;G(Gp,nj,5,Fp);var Hp=new pj;G(Hp,oj,9,Gp);G(ek,pj,4,Hp)}var Ip=new Pj;Xd(Ip,rj,20,
Qj,ek);vr(Ip)}else{var Jp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Jp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});rm("appCrashed",Jp)}Rr++}else"WARNING"===h&&Jr.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var De=h;if(M("errors_via_jspb")){if(Xr())var Lp=void 0;else{var yd=new jj;D(yd,1,H.stack);H.fileName&&D(yd,4,H.fileName);var Jb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Jb.length&&(1!==
Jb.length||isNaN(Number(Jb[0]))?2!==Jb.length||isNaN(Number(Jb[0]))||isNaN(Number(Jb[1]))||(D(yd,2,Number(Jb[0])),D(yd,3,Number(Jb[1]))):D(yd,2,Number(Jb[0])));var Bc=new mj;D(Bc,1,H.message);D(Bc,3,H.name);D(Bc,6,H.sampleWeight);"ERROR"===De?D(Bc,2,2):"WARNING"===De?D(Bc,2,1):D(Bc,2,0);var fk=new kj;D(fk,1,!0);Xd(fk,jj,3,lj,yd);var dc=new gj;D(dc,3,window.location.href);for(var Mp=L("FEXP_EXPERIMENTS",[]),gk=0;gk<Mp.length;gk++){var Qv=Mp[gk];Dd(dc);Qd(dc,5,2,!1).push(Qv)}var hk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Ck()&&hk)for(var Np=p(Object.keys(hk)),Cc=Np.next();!Cc.done;Cc=Np.next()){var Op=Cc.value,ik=new ij;D(ik,1,Op);ik.setValue(String(hk[Op]));Zd(dc,4,ij,ik)}var jk=H.params;if(jk){var Pp=p(Object.keys(jk));for(Cc=Pp.next();!Cc.done;Cc=Pp.next()){var Qp=Cc.value,kk=new ij;D(kk,1,"client."+Qp);kk.setValue(String(jk[Qp]));Zd(dc,4,ij,kk)}}var Rp=L("SERVER_NAME"),Sp=L("SERVER_VERSION");if(Rp&&Sp){var lk=new ij;D(lk,1,"server.name");lk.setValue(Rp);Zd(dc,4,ij,lk);var mk=new ij;D(mk,1,"server.version");
mk.setValue(Sp);Zd(dc,4,ij,mk)}var Vg=new nj;G(Vg,gj,1,dc);G(Vg,kj,2,fk);G(Vg,mj,3,Bc);Lp=Vg}var Tp=Lp;if(!Tp)break a;var Up=new Pj;Xd(Up,nj,163,Qj,Tp);vr(Up)}else{if(Xr())var Vp=void 0;else{var Ee={stackTrace:H.stack};H.fileName&&(Ee.filename=H.fileName);var Kb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Kb.length&&(1!==Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(Ee.lineNumber=Number(Kb[0]),Ee.columnNumber=Number(Kb[1])):Ee.lineNumber=
Number(Kb[0]));var nk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===De?nk.level="ERROR_LEVEL_ERROR":"WARNING"===De&&(nk.level="ERROR_LEVEL_WARNNING");var Rv={isObfuscated:!0,browserStackInfo:Ee},zd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(zd.experimentIds=L("FEXP_EXPERIMENTS"));var ok=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Ck()&&ok)for(var Wp=p(Object.keys(ok)),Dc=Wp.next();!Dc.done;Dc=Wp.next()){var Xp=
Dc.value;zd.kvPairs.push({key:Xp,value:String(ok[Xp])})}var pk=H.params;if(pk){var Yp=p(Object.keys(pk));for(Dc=Yp.next();!Dc.done;Dc=Yp.next()){var Zp=Dc.value;zd.kvPairs.push({key:"client."+Zp,value:String(pk[Zp])})}}var $p=L("SERVER_NAME"),aq=L("SERVER_VERSION");$p&&aq&&(zd.kvPairs.push({key:"server.name",value:$p}),zd.kvPairs.push({key:"server.version",value:aq}));Vp={errorMetadata:zd,stackTrace:Rv,logMessage:nk}}var bq=Vp;if(!bq)break a;rm("clientError",bq)}if("ERROR"===De||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
H.stack);for(var cq=p(Object.keys(Fe)),qk=cq.next();!qk.done;qk=cq.next()){var dq=qk.value;ec.postParams["client."+dq]=Fe[dq]}var rk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(rk)for(var eq=p(Object.keys(rk)),sk=eq.next();!sk.done;sk=eq.next()){var fq=sk.value;ec.postParams[fq]=rk[fq]}var gq=L("SERVER_NAME"),hq=L("SERVER_VERSION");gq&&hq&&(ec.postParams["server.name"]=gq,ec.postParams["server.version"]=hq)}kl(L("ECATCHER_REPORT_HOST","")+"/error_204",ec)}try{Pr.add(H.message)}catch(ux){}Qr++}}}}
...
function $r(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.hr("ABORTED")}
...
return a.join("")}
;var ds=y.ytLoggingDocDocumentNonce_;ds||(ds=cs(),z("ytLoggingDocDocumentNonce_",ds));var es=ds;var fs={Vh:0,re:1,Ce:2,Ql:3,Xh:4,lq:5,Gm:6,to:7,Mn:8,fo:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function gs(a){this.i=a}
...
;var ts={qe:3611,Bd:27686,Cd:85013,Dd:23462,Fd:157557,Gd:42016,Hd:62407,Id:26926,Ed:43781,Jd:51236,Kd:79148,Ld:50160,Md:77504,Yd:153587,Zd:87907,ae:18630,be:54445,ce:80935,de:152172,ee:105675,ge:150723,he:37521,ie:147285,je:47786,ke:98349,le:123695,me:6827,ne:29434,oe:7282,pe:124448,te:32276,se:76278,ue:147868,we:147869,xe:93911,ye:106531,ze:27259,Ae:27262,Be:27263,De:21759,Ee:27107,Fe:62936,Ge:160866,He:49568,Ie:160789,Je:38408,Ke:80637,Le:68727,Me:68728,Ne:80353,Oe:80356,Pe:74610,Qe:45707,Re:83962,
Se:83970,Te:46713,Ue:89711,Ve:74612,We:155792,Xe:93265,Ye:74611,Ze:131380,bf:128979,cf:139311,df:128978,af:131391,ef:105350,gf:139312,hf:134800,ff:131392,kf:113533,lf:93252,mf:99357,pf:94521,qf:114252,rf:113532,sf:94522,nf:94583,tf:88E3,uf:139580,vf:93253,wf:93254,xf:94387,yf:94388,zf:93255,Af:97424,jf:72502,Bf:110111,Cf:76019,Ef:117092,Ff:117093,Df:89431,Gf:110466,Hf:77240,If:60508,Jf:148123,Kf:148124,Lf:137401,Mf:137402,Nf:137046,Of:73393,Pf:113534,Qf:92098,Rf:131381,Sf:84517,Tf:83759,Uf:80357,
Vf:86113,Wf:72598,Xf:72733,Yf:107349,Zf:124275,ag:118203,cg:133275,dg:160157,eg:152569,fg:156651,gg:133274,hg:160159,ig:160158,jg:133272,kg:133273,lg:133276,mg:144507,ng:143247,og:156652,pg:143248,qg:143249,rg:143250,sg:143251,tg:156653,ug:144401,wg:117431,vg:133797,xg:153964,yg:128572,zg:133405,Ag:117429,Bg:117430,Cg:117432,Dg:120080,Eg:117259,Fg:156655,Gg:156654,Hg:121692,Ig:145656,Jg:156656,Kg:145655,Lg:145653,Mg:145654,Ng:145657,Og:132972,Pg:133051,Qg:133658,Rg:132971,Sg:97615,Ug:143359,Tg:143356,
Wg:143361,Vg:143358,Yg:143360,Xg:143357,Zg:142303,ah:143353,bh:143354,dh:144479,eh:143355,fh:31402,hh:133624,ih:146477,jh:133623,kh:133622,gh:133621,lh:84774,nh:160801,mh:95117,oh:150497,ph:98930,qh:98931,rh:98932,sh:153320,th:153321,uh:43347,vh:129889,wh:149123,xh:45474,yh:100352,zh:84758,Ah:98443,Bh:117985,Ch:74613,Dh:155911,Eh:74614,Fh:64502,Gh:136032,Hh:74615,Ih:74616,Jh:122224,Kh:74617,Lh:77820,Mh:74618,Nh:93278,Oh:93274,Ph:93275,Qh:93276,Rh:22110,Sh:29433,Th:133798,Uh:132295,Wh:120541,Yh:82047,
Zh:113550,ai:75836,bi:75837,ci:42352,di:84512,fi:76065,gi:75989,li:16623,mi:32594,ni:27240,oi:32633,ri:74858,si:156999,vi:3945,ti:16989,wi:45520,xi:25488,yi:25492,zi:25494,Ai:55760,Bi:14057,Ci:18451,Di:57204,Ei:57203,Fi:17897,Gi:57205,Hi:18198,Ii:17898,Ji:17909,Ki:43980,Li:46220,Mi:11721,Ni:147994,Oi:49954,Pi:96369,Qi:3854,Ri:151633,Si:56251,Ti:159108,Ui:25624,Vi:152036,mj:16906,nj:99999,oj:68172,pj:27068,qj:47973,rj:72773,sj:26970,tj:26971,uj:96805,vj:17752,wj:73233,xj:109512,yj:22256,zj:14115,Aj:22696,
Bj:89278,Cj:89277,Dj:109513,Ej:43278,Fj:43459,Gj:43464,Hj:89279,Ij:43717,Jj:55764,Kj:22255,Lj:147912,Mj:89281,Nj:40963,Oj:43277,Pj:43442,Qj:91824,Rj:120137,Sj:96367,Tj:36850,Uj:72694,Vj:37414,Wj:36851,Yj:124863,Xj:121343,Zj:73491,ak:54473,bk:43375,ck:46674,dk:143815,ek:139095,fk:144402,gk:149968,hk:149969,ik:32473,jk:72901,kk:72906,lk:50947,mk:50612,nk:50613,pk:50942,qk:84938,rk:84943,sk:84939,tk:84941,uk:84944,vk:84940,wk:84942,xk:35585,yk:51926,zk:79983,Ak:63238,Bk:18921,Ck:63241,Dk:57893,Ek:41182,
Fk:135732,Gk:33424,Hk:22207,Ik:42993,Jk:36229,Kk:22206,Lk:22205,Mk:18993,Nk:19001,Ok:18990,Pk:18991,Qk:18997,Rk:18725,Sk:19003,Tk:36874,Uk:44763,Vk:33427,Wk:67793,Xk:22182,Yk:37091,Zk:34650,al:50617,bl:47261,dl:22287,fl:25144,il:97917,jl:62397,kl:150871,ll:150874,ml:125598,nl:137935,ol:36961,pl:108035,ql:27426,rl:27857,sl:27846,ul:27854,vl:69692,wl:61411,xl:39299,yl:38696,zl:62520,Al:36382,Bl:108701,Cl:50663,Dl:36387,El:14908,Fl:37533,Gl:105443,Hl:61635,Il:62274,Jl:133818,Kl:65702,Ll:65703,Ml:65701,
Nl:76256,Ol:37671,Pl:49953,Rl:36216,Sl:28237,Tl:39553,Ul:29222,Vl:26107,Wl:38050,Xl:26108,Zl:120745,Yl:26109,am:26110,bm:66881,cm:28236,dm:14586,em:160598,fm:57929,gm:74723,hm:44098,im:44099,lm:23528,mm:61699,jm:134104,km:134103,nm:59149,om:101951,pm:97346,qm:118051,rm:95102,sm:64882,tm:119505,um:63595,vm:63349,wm:95101,xm:75240,ym:27039,zm:68823,Am:21537,Bm:83464,Cm:75707,Dm:83113,Em:101952,Fm:101953,Hm:79610,Im:125755,Jm:24402,Km:24400,Lm:32925,Nm:57173,Mm:156421,Om:122502,Pm:145268,Qm:138480,Rm:64423,
Sm:64424,Tm:33986,Um:100828,Vm:129089,Wm:21409,an:135155,bn:135156,cn:135157,dn:135158,en:158225,fn:135159,gn:135160,hn:135161,kn:135162,ln:135163,jn:158226,mn:158227,nn:135164,pn:135165,qn:135166,Xm:11070,Ym:11074,Zm:17880,rn:14001,tn:30709,un:30707,vn:30711,wn:30710,xn:30708,sn:26984,yn:146143,zn:63648,An:63649,Bn:51879,Cn:111059,Dn:5754,En:20445,Fn:151308,Gn:151152,In:130975,Hn:130976,Jn:110386,Kn:113746,Ln:66557,Nn:17310,On:28631,Pn:21589,Qn:154946,Rn:68012,Sn:60480,Tn:138664,Un:141121,Vn:31571,
Wn:141978,Xn:150105,Yn:150106,Zn:150107,ao:150108,bo:76980,co:41577,eo:45469,ho:38669,jo:13768,ko:13777,lo:141842,mo:62985,no:4724,oo:59369,po:43927,qo:43928,ro:12924,so:100355,vo:56219,wo:27669,xo:10337,uo:47896,yo:122629,Ao:139723,zo:139722,Bo:121258,Co:107598,Do:127991,Eo:96639,Fo:107536,Go:130169,Ho:96661,Io:145188,Jo:96658,Ko:116646,Lo:159428,Mo:121122,No:96660,Oo:127738,Po:127083,Qo:155281,Ro:147842,So:104443,To:96659,Uo:147595,Vo:106442,Wo:134840,Xo:63667,Yo:63668,Zo:63669,ap:130686,bp:147036,
cp:78314,ep:147799,fp:148649,gp:55761,hp:127098,ip:134841,jp:96368,kp:67374,lp:48992,mp:146176,np:49956,qp:31961,rp:26388,sp:23811,tp:5E4,up:126250,vp:96370,wp:47355,xp:47356,yp:37935,zp:45521,Ap:21760,Bp:83769,Cp:49977,Dp:49974,Ep:93497,Fp:93498,Gp:34325,Hp:140759,Ip:115803,Jp:123707,Kp:100081,Lp:35309,Mp:68314,Np:25602,Op:100339,Pp:143516,Qp:59018,Rp:18248,Sp:50625,Tp:9729,Up:37168,Vp:37169,Wp:21667,Xp:16749,Yp:18635,Zp:39305,aq:18046,bq:53969,cq:8213,fq:93926,gq:102852,hq:110099,iq:22678,jq:69076,
kq:137575,mq:139224,nq:100856,oq:154430,pq:17736,qq:3832,rq:147111,sq:55759,tq:64031,Aq:93044,Bq:93045,Cq:34388,Dq:17657,Eq:17655,Fq:39579,Gq:39578,Hq:77448,Iq:8196,Jq:11357,Kq:69877,Lq:8197,Mq:156512,Nq:156509,Oq:82039};function us(){var a=vb(vs),b;return(new yf(function(c,d){a.onSuccess=function(e){cl(e)?c(new ws(e)):d(new xs("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
b=kl("//googleads.g.doubleclick.net/pagead/id",a)})).jb(function(c){c instanceof Ff&&b.abort();
return Df(c)})}
function xs(a,b,c){ab.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
t(xs,ab);function ws(a){this.xhr=a}
...
t(Fs,ab);Fs.prototype.name="BiscottiError";function Gs(){ab.call(this,"Biscotti ID is missing from server")}
t(Gs,ab);Gs.prototype.name="BiscottiMissingError";var vs={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Hs=null;function Is(){if(M("disable_biscotti_fetch_entirely_for_all_web_clients"))return Error("Biscotti id fetching has been disabled entirely.");if(!Ds())return Error("User has not consented - not fetching biscotti id.");var a=L("PLAYER_VARS",{});if("1"==tb(a))return Error("Biscotti ID is not available in private embed mode");if(Es(a))return Error("Biscotti id fetching has been disabled for pfl.")}
function Nk(){var a=Is();if(void 0!==a)return Df(a);Hs||(Hs=us().then(Js).jb(function(b){return Ks(2,b)}));
return Hs}
...
function Ls(a,b){dl(function(){us().then(Js,function(c){return Ks(b,c)}).jb(cb)},a)}
...
function et(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.providers.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.providers.get(b);c.push(b);if(d.vc)var e=d.vc;else if(d.Ad)e=d[$s]?ft(a,d[$s],c):[],e=d.Ad.apply(d,ia(e));else if(d.uc){e=d.uc;var f=e[$s]?ft(a,e[$s],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ia(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.mr||a.i.set(b,e);
return e}
...
Il())h.connectionType=k;M("web_log_effective_connection_type")&&(k=Jl())&&(g.client.effectiveConnectionType=k)}var q;if(M("web_log_memory_total_kbytes")&&(null==(q=y.navigator)?0:q.deviceMemory)){var r;q=null==(r=y.navigator)?void 0:r.deviceMemory;g.client.memoryTotalKbytes=""+1E6*q}r=Wk(y.location.href);!M("web_populate_internal_geo_killswitch")&&r.internalcountrycode&&(h.internalGeo=r.internalcountrycode);"MWEB"===h.clientName||"WEB"===h.clientName?(h.mainAppWebInfo={graftUrl:y.location.href},M("kevlar_woffle")&&
sl.i&&(r=sl.i,h.mainAppWebInfo.pwaInstallabilityStatus=!r.i&&r.j?"PWA_INSTALLABILITY_STATUS_CAN_BE_INSTALLED":"PWA_INSTALLABILITY_STATUS_UNKNOWN"),h.mainAppWebInfo.webDisplayMode=tl(),h.mainAppWebInfo.isWebNativeShareAvailable=navigator&&void 0!==navigator.share):"TVHTML5"===h.clientName&&(!M("web_lr_app_quality_killswitch")&&(r=L("LIVING_ROOM_APP_QUALITY"))&&(h.tvAppInfo=Object.assign(h.tvAppInfo||{},{appQuality:r})),r=L("LIVING_ROOM_CERTIFICATION_SCOPE"))&&(h.tvAppInfo=Object.assign(h.tvAppInfo||
{},{certificationScope:r}));if(!M("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var w=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(ob){}w=void 0}w&&(h.timeZone=w)}(w=Fk())?h.experimentsToken=w:delete h.experimentsToken;w=Gk();Ts.i||(Ts.i=new Ts);h=Ts.i.i;r=[];q=0;for(var u in h)r[q++]=h[u];g.request=Object.assign({},g.request,{internalExperimentFlags:w,consistencyTokenJars:r});!M("web_prequest_context_killswitch")&&(u=L("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&
...
{};b.key=L("INNERTUBE_API_KEY");M("json_condensed_response")&&(b.prettyPrint="false");W=Xk(W,b||{},!1);a=M("kevlar_response_command_processor_page")?Object.assign({},{command:a},void 0):Object.assign({},void 0);a={input:W,va:Cs(W),ga:F,config:a};a.config.Ua?a.config.Ua.identity=c:a.config.Ua={identity:c};return a}Vr(new Q("Error: Failed to create Request from Command.",a))};
ea.Object.defineProperties(nt.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!1}}});function ot(){}
t(ot,nt);ot.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",va:Cs("/getDatasyncIdsEndpoint","GET"),ga:{}}};
...
t(wt,Zn);var xt=new $n("aft-recorded",wt);var zt=window;function At(){this.timing={};this.clearResourceTimings=function(){};
...
Wa(S.clearResourceTimings||S.webkitClearResourceTimings||S.mozClearResourceTimings||S.msClearResourceTimings||S.oClearResourceTimings||cb,S);function Dt(a){var b=Et(a);if(b.aft)return b.aft;a=L((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
...
V[V.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var bu={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};bu[bu.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";bu[bu.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";bu[bu.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
lu.prototype.tick=function(a,b,c,d){nu(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Mj,D(d,1,a),D(d,2,b),a=new Pj,Xd(a,Mj,5,Qj,d),vr(a,c)):rm("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
...
lu.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));nu(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new Pj,Xd(c,Ij,7,Qj,a),vr(c,b))};
...
function Du(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Qs:c;var d=Zs(b,a.o);if(!d)return Df(new Q("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new yf(function(f){var g,h,k;return x(function(m){if(1==m.i){h="cors"===(null==(g=e.va)?void 0:g.mode)?"cors":void 0;if(a.m.td){var q=e.config,r;q=null==q?void 0:null==(r=q.Ua)?void 0:r.sessionIndex;r=Ps({sessionIndex:q});k=Object.assign({},Eu(h),r);return m.u(2)}return v(m,Fu(e.config,
h),3)}2!=m.i&&(k=m.j);f(Gu(a,e,k));m.i=0})}):Df(new Q("Error: Failed to build request for command.",b))}
function Hu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.kr)?0:d.pr)&&a.l){d=p(zu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function Gu(a,b,c){var d,e,f,g,h,k,m,q,r,w,u,A,E,F,O,N,R,ca,W,ob,Xa,ma,H,la,fa,Be,Ce,wd;return x(function(oa){switch(oa.i){case 1:oa.u(2);break;case 3:if((d=oa.j)&&!d.isExpired())return oa.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.gr(b.ga.context);if(null==(m=a.j)||!m.lr(b.input,b.ga)){oa.u(4);break}return v(oa,a.j.Zq(b.input,b.ga),5);case 5:return q=oa.j,M("kevlar_process_local_innertube_responses_killswitch")||
Hu(a,q,b),oa.return(q);case 4:return(u=null==(w=b.config)?void 0:w.Ba)&&a.i.has(u)&&M("web_memoize_inflight_requests")?r=a.i.get(u):(A=JSON.stringify(b.ga),O=null!=(F=null==(E=b.va)?void 0:E.headers)?F:{},b.va=Object.assign({},b.va,{headers:Object.assign({},O,c)}),N=Object.assign({},b.va),"POST"===b.va.method&&(N=Object.assign({},N,{body:A})),(null==(R=b.config)?0:R.fd)&&Z(b.config.fd),ca=function(){return a.N.fetch(b.input,N,b.config)},r=ca(),u&&a.i.set(u,r)),v(oa,r,6);
case 6:W=oa.j;if(M("web_one_platform_error_handling")&&(null==(ob=W)?0:null==(Xa=ob.error)?0:Xa.details))for(ma=W.error.details,H=p(ma),la=H.next();!la.done;la=H.next())fa=la.value,(Be=fa["@type"])&&-1<Au.indexOf(Be)&&(delete fa["@type"],W=fa);u&&a.i.has(u)&&a.i.delete(u);(null==(Ce=b.config)?0:Ce.gd)&&Z(b.config.gd);if(W||null==(wd=a.j)||!wd.Tq(b.input,b.ga)){oa.u(7);break}return v(oa,a.j.Yq(b.input,b.ga),8);case 8:W=oa.j;case 7:return Hu(a,W,b),oa.return(W)}})}
function Fu(a,b){var c,d,e,f;return x(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ua)?void 0:d.sessionIndex;var h=Ps({sessionIndex:e});if(!(h instanceof yf)){var k=new yf(cb);zf(k,2,h);h=k}return v(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},Eu(b),f)))})}
...
t(Pu,nt);Pu.prototype.l=function(){return Nu};
...
ea.Object.defineProperties(Pu.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Qu(){}
t(Qu,nt);Qu.prototype.l=function(){return Ou};
...
ea.Object.defineProperties(Qu.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Ru(){}
t(Ru,nt);Ru.prototype.l=function(){return Ku};
...
t(Su,nt);Su.prototype.l=function(){return Lu};
...
t(Tu,nt);Tu.prototype.l=function(){return Mu};
Tu.prototype.i=function(a){return Bs(a,Yj)||void 0};
...
t(Uu,nt);Uu.prototype.l=function(){return Ju};
...
t(Yu,Zn);var io=new $n("screen-created",Yu),Zu=[],av=$u,bv=0;function cv(a,b,c,d,e,f,g){function h(){Wr(new Q("newScreen() parent element does not have a VE - rootVe",b))}
...
aa:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(rb(g)||!g.trackingParams&&!g.veType)&&Wr(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new zj;h.l(b);Bj(h,c.getAsJspb());hb(e,function(k){k=k.getAsJspb();Zd(h,3,tj,k)});
...
function ev(a,b,c,d){Zu.push({payloadName:a,payload:c,ta:d,options:b});bv||(bv=jo())}
function ko(a){if(Zu){for(var b=p(Zu),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.ta.l(a.csn),c.payloadName){case "screenCreated":Ar(c.ta,c.options);break;case "visualElementAttached":Br(c.ta,c.options);break;case "visualElementShown":wr(c.ta,c.options);break;case "visualElementHidden":xr(c.ta,c.options);break;case "visualElementGestured":yr(c.ta,c.options);break;case "visualElementStateChanged":zr(c.ta,c.options);break;default:Wr(new Q("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
...
ns(c.layer)||a.l();if(c.Vb)for(var d=p(c.Vb),e=d.next();!e.done;e=d.next())hv(a,e.value,c.layer);else Vr(Error("Delayed screen needs a data promise."))}
function kv(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Zc?c.Zc:c.layer;var e=ns(d);d=ls(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=cv(a.client,b,f,c.Ub,c.cttAuthInfo,g,c.Wq)}catch(m){Yr(m,{ir:b,rootVe:d,parentVisualElement:void 0,Uq:e,fr:f,Ub:c.Ub});Vr(m);return}qs(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(fs));for(f=b.next();!f.done;f=b.next())if(ns(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:ps(e)||void 0,aa:e,Wb:g},M("il_via_jspb")?(h=new Dj,h.l(e),d=d.getAsJspb(),G(h,tj,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"===e?ev("visualElementHidden",f,void 0,h):xr(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"===e?ev("visualElementHidden",f,d):b?qr("visualElementHidden",
...
;function lv(){var a,b;return x(function(c){if(1==c.i)return a=ht().resolve(Iu),a?v(c,Du(a),2):(Wr(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Wr(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.Vq);Wr(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var mv=y.caches,nv;function ov(a){var b=a.indexOf(":");return-1===b?{ic:a}:{ic:a.substring(0,b),datasyncId:a.substring(b+1)}}
...
l.isInitialized=function(){return!!this.ub()};
function Tv(a,b,c,d){a.state=5;try{var e=new Ch({program:b,globalName:c,dd:M("att_web_record_metrics")});e.qd.then(function(){a.state=6;d&&d(b)});
a.Fb(e)}catch(f){a.state=7,f instanceof Error&&Wr(f)}}
l.invoke=function(a){a=void 0===a?{}:a;var b=this.ub();if(b){var c={Tb:a};if(b.Za)throw Error("Already disposed");a=Ah();var d;null!=(d=b.sa)&&d.j.i.Ib("/client_streamz/bg/fsc",d.Ba);d=b.ud([c.Tb,c.sd]);null!=(b=b.sa)&&(a=Ah()-a,b.l.i.kb("/client_streamz/bg/fsl",a,b.Ba));b=d}else b=null;return b};
l.dispose=function(){this.Jb()};
l.Jb=function(){this.Fb(null);this.state=8};
l.ub=function(){return this.i};
l.Fb=function(a){pe(this.i);this.i=a};function Uv(){Pv.apply(this,arguments)}
t(Uv,Pv);Uv.prototype.Jb=function(){this.state=8};
Uv.prototype.ub=function(){return B("yt.abuse.playerAttLoader")};
Uv.prototype.Fb=function(a){pe(B("yt.abuse.playerAttLoader"));z("yt.abuse.playerAttLoader",a);a&&z("yt.abuse.playerAttLoaderRun",function(b){return a.snapshot(b)})};var Vv=new Uv;var Wv=new Pv;function Xv(){return M("use_player_abuse_bg_library")?Vv.isInitialized():Wv.isInitialized()}
function Yv(a){a=void 0===a?{}:a;M("use_player_abuse_bg_library")?(a=void 0===a?{}:a,a=Vv.invoke(a)):a=Wv.invoke(a);return a}
;function Zv(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?gm():d;this.m=c;this.l=d;this.j=new Bh;this.i=a;a={};c=p(this.i.entries());for(d=c.next();!d.done;a={Da:a.Da,Na:a.Na},d=c.next()){var e=p(d.value);d=e.next().value;e=e.next().value;a.Na=d;a.Da=e;d=function(f){return function(){f.Da.xb();b.i[f.Na].hb=!0;b.i.every(function(g){return!0===g.hb})&&b.j.resolve()}}(a);
e=cm(d,$v(this,a.Da));this.i[a.Na]=Object.assign({},a.Da,{xb:d,cb:e})}}
function aw(a){var b=Array.from(a.i.keys()).sort(function(d,e){return $v(a,a.i[e])-$v(a,a.i[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.cb||c.hb||(a.l.ea(c.cb),cm(c.xb,10))}
Zv.prototype.cancel=function(){for(var a=p(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.cb||b.hb||this.l.ea(b.cb),b.hb=!0;this.j.resolve()};
...
gm();var g={};e=p(e);for(var h=e.next();!h.done;g={Oa:g.Oa},h=e.next())g.Oa=h.value,em(function(k){return function(){k.Oa.callback.apply(k.Oa,ia(d))}}(g));
f=f.map(function(k){var m;return{xb:function(){k.callback.apply(k,ia(d))},
priority:null!=(m=null!=c?c:k.priority)?m:0}});
f.length&&(a.l=new Zv(f))}}
ea.Object.defineProperties(bw.prototype,{currentState:{configurable:!0,enumerable:!0,get:function(){return this.state}}});function dw(a){bw.call(this,void 0===a?"document_active":a);var b=this;this.s=10;this.i=new Map;this.C=[{from:"document_active",F:"document_disposed_preventable",action:this.I},{from:"document_active",F:"document_disposed",action:this.m},{from:"document_disposed_preventable",F:"document_disposed",action:this.m},{from:"document_disposed_preventable",F:"flush_logs",action:this.o},{from:"document_disposed_preventable",F:"document_active",action:this.j},{from:"document_disposed",F:"flush_logs",action:this.o},
...
t(ew,bw);ew.prototype.j=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
...
var hw;t(gw,fw);gw.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new sj,b=ns();b&&D(a,1,b);b=new Pj;Xd(b,sj,380,Qj,a);vr(b);M("web_fp_via_jspb_and_json")&&rm("finalPayload",{csn:ns()})}else rm("finalPayload",{csn:ns()})};
...
t(mw,J);mw.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){Lk(d)}}};
mw.prototype.D=function(){window.removeEventListener("message",this.v);J.prototype.D.call(this)};function nw(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new mw(!!L("WIDGET_ID_ENFORCE")),b=this.cd.bind(this);a.o=b;a.s=null;this.i.channel="widget";if(a=L("WIDGET_ID"))this.i.sessionId=a}
l=nw.prototype;l.cd=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,ow(this,a)),this.l[a]=!0)):this.Kb(a,b,c)};
l.Kb=function(){};
function ow(a,b){return function(c){return a.sendMessage(b,c)}}
l.addEventListener=function(){};
l.Oc=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.sb());this.sendMessage("onReady");fb(this.j,this.pc,this);this.j=[]};
l.sb=function(){return null};
function pw(a,b){a.sendMessage("infoDelivery",b)}
l.pc=function(a){this.isReady?this.i.sendMessage(a):this.j.push(a)};
...
;function ww(a){nw.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.nd.bind(this));this.addEventListener("onVolumeChange",this.od.bind(this));this.addEventListener("onApiChange",this.hd.bind(this));this.addEventListener("onPlaybackQualityChange",this.kd.bind(this));this.addEventListener("onPlaybackRateChange",this.ld.bind(this));this.addEventListener("onStateChange",this.md.bind(this));this.addEventListener("onWebglSettingsChanged",
this.pd.bind(this))}
t(ww,nw);l=ww.prototype;
l.Kb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&tw(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=uw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=uw(e);break;case "loadPlaylist":case "cuePlaylist":e=vw(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);tw(a)&&pw(this,this.sb())}};
l.onReady=function(){var a=this.Oc.bind(this);this.i.j=a;a=this.api.getVideoData();if(!a.isPlayable){a=a.errorCode;var b=void 0===b?5:b;this.sendMessage("onError",(a?rw[a]||b:b).toString())}};
l.addEventListener=function(a,b){this.listeners.push({eventType:a,listener:b});this.api.addEventListener(a,b)};
l.sb=function(){if(!this.api)return null;var a=this.api.getApiInterface();lb(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c];if(0===e.search("get")||0===e.search("is")){var f=0;0===e.search("get")?f=3:0===e.search("is")&&(f=2);f=e.charAt(f).toLowerCase()+e.substr(f+1);try{var g=this.api[e]();b[f]=g}catch(h){}}}b.videoData=this.api.getVideoData();b.currentTimeLastUpdated_=Date.now()/1E3;return b};
l.md=function(a){a={playerState:a,currentTime:this.api.getCurrentTime(),duration:this.api.getDuration(),videoData:this.api.getVideoData(),videoStartBytes:0,videoBytesTotal:this.api.getVideoBytesTotal(),videoLoadedFraction:this.api.getVideoLoadedFraction(),playbackQuality:this.api.getPlaybackQuality(),availableQualityLevels:this.api.getAvailableQualityLevels(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getVideoUrl&&
...
l.kd=function(a){pw(this,{playbackQuality:a})};
l.ld=function(a){pw(this,{playbackRate:a})};
l.hd=function(){for(var a=this.api.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.api.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var k=f[g],m=this.api.getOption(e,k);b[e][k]=m}}this.sendMessage("apiInfoDelivery",b)};
l.od=function(){pw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
l.nd=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());pw(this,a)};
l.pd=function(){var a={sphericalProperties:this.api.getSphericalProperties()};pw(this,a)};
l.dispose=function(){nw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function xw(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.kc,this)}
...
l.kc=function(a,b,c){if(this.started&&!this.i()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=yw(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=zw(a,c))&&this.wa(a,c))}}};
l.addListener=function(a){if(!(a in this.j)){var b=this.jd.bind(this,a);this.j[a]=b;this.addEventListener(a,b)}};
l.jd=function(a,b){this.started&&!this.i()&&this.connection.wa(a,this.rb(a,b))};
l.rb=function(a,b){if(null!=b)return{value:b}};
l.removeListener=function(a){a in this.j&&(this.removeEventListener(a,this.j[a]),delete this.j[a])};
l.D=function(){var a=this.connection;a.i()||vi(a.j,"command",this.kc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function Aw(a,b){xw.call(this,b);this.api=a;this.start()}
...
Aw.prototype.rb=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return xw.prototype.rb.call(this,a,b)};
...
t(Kw,J);Kw.prototype.D=function(){for(;this.j.length;){var a=this.j.pop();a.target.removeEventListener(a.name,a.callback,void 0)}J.prototype.D.call(this)};function Lw(){Kw.apply(this,arguments)}
t(Lw,Kw);function Mw(a,b,c,d){J.call(this);var e=this;this.v=b;this.webPlayerContextConfig=d;this.ca=!1;this.api={};this.V=this.s=null;this.L=new K;this.j={};this.R=this.W=this.elementId=this.ra=this.config=null;this.P=!1;this.m=this.G=null;this.ka={};this.Sa=["onReady"];this.lastError=null;this.Fa=NaN;this.K={};this.Ta=new Lw(this);this.T=0;this.l=this.o=a;re(this,this.L);Nw(this);Ow(this);re(this,this.Ta);c?this.T=dl(function(){e.loadNewVideoConfig(c)},0):d&&(Pw(this),Qw(this))}
...
function Xw(a){if(!a.i()){var b=Vw(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Zw(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}bx(a)}else a.Fa=dl(function(){Xw(a)},50)}}
function bx(a){Nw(a);a.ca=!0;var b=Vw(a);if(b){a.s=cx(a,b,"addEventListener");a.V=cx(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=cx(a,b,f))}}for(var g in a.j)a.j.hasOwnProperty(g)&&a.s&&a.s(g,a.j[g]);Rw(a);a.W&&a.W(a.api);a.L.qa("onReady",a.api)}
...
l.addEventListener=function(a,b){var c=this,d=Tw(this,b);d&&(0<=eb(this.Sa,a)||this.j[a]||(b=dx(this,a),this.s&&this.s(a,b)),this.L.subscribe(a,d),"onReady"===a&&this.isReady()&&dl(function(){d(c.api)},0))};
...
function dx(a,b){var c="ytPlayer"+b+a.v;a.j[b]=c;y[c]=function(d){var e=dl(function(){if(!a.i()){try{a.L.qa(b,null!=d?d:void 0)}catch(h){Wr(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.v,data:d}))}var f=a.K,g=String(e);g in f&&delete f[g]}},0);
sb(a.K,String(e))};
return c}
...
l.cancel=function(){this.G&&Kv(Ww(this),this.G);el(this.Fa);this.P=!1};
l.D=function(){Yw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Vr(b)}this.ka=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.ra=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
...
px(d,b,h)}else px(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var r=void 0===r?Ph:r;a:{r=void 0===r?Ph:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Nh&&m.isValid(a)){r=new Ob(a,Pb);break a}r=void 0}r=r||Sb;if(r instanceof Ob)var w=Qb(r);else{b:if(Fh){try{w=new URL(r)}catch(u){w="https:";break b}w=w.protocol}else c:{w=document.createElement("a");try{w.href=r}catch(u){w=void 0;
